...
const HEADLINES: Record<UpgradeReason, string> = {
  items:     "UNLOCK YOUR UNLIMITED DIGITAL EVENTS",
  outfits:   "UNLOCK YOUR UNLIMITED DIGITAL EVENTS",
  mannequin: "UNLOCK YOUR UNLIMITED DIGITAL EVENTS",
};

const SUBTITLES: Record<UpgradeReason, string> = {
  items:     "You've reached the free 20 item limit.\nUpgrade once, plan everything.",
